...
mir = new MusicIntentReceiver();
        ...
        quitPendingIntent = PendingIntent.getBroadcast(parent, 0, new Intent("com.nyimbozamani.nyimbozazamani.quit"), 0);
        playpausePendingIntent = PendingIntent.getBroadcast(parent, 0, new Intent("com.nyimbozamani.nyimbozazamani.playpause"), 0);
        nextPendingIntent = PendingIntent.getBroadcast(parent, 0, new Intent("com.nyimbozamani.nyimbozazamani.next"), 0);
