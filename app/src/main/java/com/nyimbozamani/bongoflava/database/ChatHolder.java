...
public class ChatHolder extends RecyclerView.ViewHolder {
    ...
    public ChatHolder(View itemView) {
        ...
        mTextField = (TextView) itemView.findViewById(R.id.artist);
    ...
    public void setFont(Typeface fonts){
        mTextField.setTypeface(fonts, Typeface.BOLD);
        mNameField.setTypeface(fonts, Typeface.BOLD);
